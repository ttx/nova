...
class RootwrapTestCase(test.TestCase):
    ...
    def test_KillFilter(self):
        ...
        f = filters.KillFilter("/bin/kill", "root", "/bin/sleep", "-9", "-HUP")
        f2 = filters.KillFilter("/bin/kill", "root", "/usr/bin/sleep", "-9",
                                "-HUP")
        ...
        f = filters.KillFilter("/bin/kill", "root", "/bin/sleep")
        f2 = filters.KillFilter("/bin/kill", "root", "/usr/bin/sleep")
    ...
    def test_KillFilter_deleted_exe(self):
        ...
        f = filters.KillFilter("/bin/kill", "root", "/bin/commandddddd")
        usercmd = ['kill', 1234]
        # Providing no signal should work
